...
// Output
int redPin = LED1_RED;   // Red LED,   connected to digital pin 9
int grnPin = LED1_GREEN;  // Green LED, connected to digital pin 10
int bluPin = LED1_BLUE;  // Blue LED,  connected to digital pin 11
